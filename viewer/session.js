...
export class ViewerSession {
  ...
  async analysisState({cancelled=()=>false}={}) {
    if(cancelled())return null;
    // Project before cloning: Reconstruction.state would clone hidden queue/RNG too.
    return visibleState(this.session.engine.state);
  }

...
await copyFile('viewer/kiwi-button.jpg','dist/kiwi-button.jpg');
...
const assets=['kiwi-button.jpg','kiwi-worker.js','kiwi-NOTICES',...Object.keys(kiwiAssets),'index.html','app.css','app.js','worker.js','manifest.webmanifest','icon-180.png','icon-192.png','icon-512.png'];
